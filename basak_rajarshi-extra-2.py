# -*- coding: utf-8 -*-
"""
Created on Fri Dec 22 15:08:55 2017
...
inputfile = open("hotelDeceptionTest.txt",'r',encoding="utf8").readlines()
outputfile = open("testouptut-2.txt","w")

posfile = open("hotelT-train.txt",'r',encoding="utf8").readlines()
...
negfile = open("hotelF-train.txt",'r',encoding="utf8").readlines()
...
#------------------------------------------------------------------------
#-----------------Sentence classifier(deception) function----------------
#------------------------------------------------------------------------
...
for k in inputfile:
    ...
    for i in range (1,len(st)):
        ...
        st2.append(cde)
    #print(st2)
    outputfile.write(k[:7] + " " + sentenceclassifier(st2) + "\n")
    st2 = []